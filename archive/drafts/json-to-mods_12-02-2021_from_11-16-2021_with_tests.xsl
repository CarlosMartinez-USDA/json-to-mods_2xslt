...
<!--                        <xsl:comment>test 2b: pub_page field, 2nd iteration</xsl:comment>-->
            ...
            <!-- <xsl:comment>test 3a: citation field, 1st iteration</xsl:comment>-->
                <xsl:analyze-string select="$citation" regex="([A-z]\d+)-([A-z]\d+)|(: pages )(\d+\-\d+)|(\d+)(\sp|\sp.&#x22;)">
                    <xsl:matching-substring>
                        <xsl:choose>
                            <!-- total_only -->
                            <xsl:when test="regex-group(5) and regex-group(6)">
                               ...
                               <!--<xsl:comment>test 3.a.i: citation-field, analyzed-string, regex-group(4)</xsl:comment>                                -->
                            </xsl:when>
                            <!-- special_cases -->
                            <xsl:when test="regex-group(1) and regex-group(2)">
                                <start>
                               ...
                               <!--<xsl:comment>test 3.a.ii: citation-field, analyzed-string, regex-group(1)</xsl:comment> -->
                            </xsl:when>
                            
                            <!-- hyphenated page range -->
                            <xsl:when test="matches(regex-group(4),'(\d+-\d+)')">
                                <start>
                               ...
                               <!--<xsl:comment>test 3.a.iii: citation-field, analyzed-string, regex-group(3)</xsl:comment> -->
                            </xsl:when>
