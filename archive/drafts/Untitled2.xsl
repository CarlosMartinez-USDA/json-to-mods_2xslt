...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0"
    ...
    <xsl:template match="map" xpath-default-namespace="http://www.w3.org/2005/xpath-functions">
        ...
        <!--accessCondtion (hard-coded)-->
        <accessCondition xmlns="https://data.crossref.org/schemas/AccessIndicators.xsd" type="use and reproduction" displayLabel="Resource is Open Access">    
